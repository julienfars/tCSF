...
for (i in dateien) {
  ...
  print(aktTab$V1)
  if (strsplit(as.character(aktTab$V1[length(aktTab$V1)]),":")[[1]][1] != "Zielfrequenz erreicht") { 
  Kontrast100 <- (aktTab[aktTab$V1=="Kontrast SC1",] > 70)
  Kontrast100 <- match(T, Kontrast100)
